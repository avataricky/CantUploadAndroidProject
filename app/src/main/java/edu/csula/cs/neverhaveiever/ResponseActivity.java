...
public class ResponseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Theme.getTheme() == R.style.BrightNightLight){
            button_have.setBackgroundColor(getResources().getColor(R.color.darkHas));
            button_have.setTextColor(getResources().getColor(R.color.darkNever));
            button_never.setBackgroundColor(getResources().getColor(R.color.darkNever));
            button_never.setTextColor(getResources().getColor(R.color.darkHas));
